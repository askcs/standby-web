define(
  ...
  function (filters, config)
  {
     ...
     */
    filters.filter('translateDivision',
        [
          '$config',
          function ($config)
          {
     ...
     */
    filters.filter('calculateTimeInDays',
      function ()
      {
     ...
     */
    filters.filter('calculateTimeInHours',
      function ()
      {
        return function (stamp)
        {
     ...
     */
    filters.filter('calculateTimeInMinutes',
      function ()
      {
        return function (stamp)
        {
     ...
     */
    filters.filter('convertUserIdToName',
        [
          'Storage',
          function (Storage)
          {
     ...
     */
    filters.filter('convertTimeStamp',
      function ()
      {
        return function (stamp)
        {
     ...
     */
    filters.filter('truncateGroupTitle',
        [
          'Strings',
          function (Strings)
          {
